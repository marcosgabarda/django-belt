...
class TestBeltFilesModule(TestCase):
    ...
    def test_upload_to_dir(self):
        ...
        self.assertEquals(path, os.path.join(destiny_path, file_name))
    ...
    def test_upload_to_dir_random_name(self):
        ...
        path = upload_to_dir(None, file_name)
        self.assertNotEquals(path, os.path.join(destiny_path, file_name))
    ...
    def test_upload_to_dir_populate(self):
        ...
        self.assertEquals(path, os.path.join(destiny_path, "%s.%s" % (Obj.title, ext)))
